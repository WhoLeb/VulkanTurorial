...
namespace lve
{
	...
	void LveRenderer::recreateSwapchain()
	{
		...
		else
		{
			...
			if (!oldSwapChain->compareSwapFromats(*lveSwapChain.get()))
			{
	...
	{
		assert(isFrameStarted && "Can't call endFrame while frame has not started");
		auto commandBuffer = getCurrentCommandBuffer();
	...
	{
		assert(isFrameStarted && "Can't call beginSwapChainRenderPass while frame has not started");
	...
	{
		assert(isFrameStarted && "Can't call endSwapChainRenderPass while frame has not started");
